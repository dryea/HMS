...
export default function AdminAnnouncements() {
  ...
  return(<div className="page-container">
    <div className="flex items-center justify-between mb-20"><h1 className="md3-headline-small m-0">Announcements</h1><button className="md3-btn" onClick={open}><IconPlus size={18}/> New</button></div>
